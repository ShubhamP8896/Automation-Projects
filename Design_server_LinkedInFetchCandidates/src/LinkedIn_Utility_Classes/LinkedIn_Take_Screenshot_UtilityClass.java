...
public class LinkedIn_Take_Screenshot_UtilityClass 
{
	    public static void takeScreenshot(WebDriver driver, String screenshotName) 
	    {
	        ...
	        String destinationFilePath = "D:\\LinkeIn Touchless candidates fetching data\\Screenshots after Fecthing results\\" + screenshotName + ".png";
