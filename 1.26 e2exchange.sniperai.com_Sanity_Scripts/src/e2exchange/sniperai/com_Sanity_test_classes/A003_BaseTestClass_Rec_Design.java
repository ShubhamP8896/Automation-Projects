package e2exchange.sniperai.com_Sanity_test_classes;
...
import e2exchange.sniperai.com_utility_Classes.E2exchange_Excel_Data_UtilityClass;
import e2exchange.sniperai.com_utility_Classes.E2exchange_Take_Screenshot_UtilityClass;
import e2exchange_RecMod_POM_classes.Rec_JobListPage_POM_Class;
import e2exchange_Sanity_POM_Classes.LoginPage;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://e2exchange.sniperai.com/");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(53);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
            ...
            E2exchange_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        } catch (WebDriverException e) {
            System.out.println("WebDriverException occurred: " + e.getMessage());
            E2exchange_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An exception occurred: " + e.getMessage());
            E2exchange_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
    }
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                E2exchange_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                E2exchange_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
