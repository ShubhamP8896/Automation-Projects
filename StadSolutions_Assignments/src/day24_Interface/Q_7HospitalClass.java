...
public class Q_7HospitalClass implements Q_7usmeHosp, Q_7ukmeHosp, Q_7indHosp
{
...
//	Object to call all the methods
	...
	{
		Q_7HospitalClass obj = new Q_7HospitalClass();
...
//		call all the methods using object ref variable
		...
		Q_7HospitalClass.hospital();        // parent interface static method is hiding
