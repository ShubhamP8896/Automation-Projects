...
public class Q_3HospitalClass implements Q_3usmeHosp, Q_3ukmeHosp, Q_3indHosp
{
...
//	Object to call all the methods
	...
	{
		Q_3HospitalClass obj = new Q_3HospitalClass();
...
//		call all the methods using object ref variable
		...
		Q_3HospitalClass.hospital();        // parent interface static method is hiding
