...
public class Q_5HospitalClass implements Q_5usmeHosp, Q_5ukmeHosp, Q_5indHosp
{
...
//	Object to call all the methods
	...
	{
		Q_5HospitalClass obj = new Q_5HospitalClass();
...
//		call all the methods using object ref variable
		...
		Q_5HospitalClass.hospital();        // parent interface static method is hiding
