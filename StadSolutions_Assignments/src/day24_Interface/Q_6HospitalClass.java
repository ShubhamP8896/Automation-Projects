...
public class Q_6HospitalClass implements Q_6usmeHosp, Q_6ukmeHosp, Q_6indHosp
{
...
//	Object to call all the methods
	...
	{
		Q_6HospitalClass obj = new Q_6HospitalClass();
...
//		call all the methods using object ref variable
		...
		Q_6HospitalClass.hospital();        // parent interface static method is hiding
