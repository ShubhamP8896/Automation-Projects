package deloittepoc.sniperai.com_Sanity_test_classes;
...
import deloittepoc.sniperai.com_utility_Classes.Deloittepoc_Excel_Data_UtilityClass;
import deloittepoc.sniperai.com_utility_Classes.Deloittepoc_Take_Screenshot_UtilityClass;
import deloittepoc_RecMod_POM_classes.Rec_JobListPage_POM_Class;
import deloittepoc_Sanity_POM_Classes.LoginPage;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://deloittepoc.sniperai.com/");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(31);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
            ...
            Deloittepoc_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        } catch (WebDriverException e) {
            System.out.println("WebDriverException occurred: " + e.getMessage());
            Deloittepoc_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An exception occurred: " + e.getMessage());
            Deloittepoc_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
    }
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Deloittepoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Deloittepoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
