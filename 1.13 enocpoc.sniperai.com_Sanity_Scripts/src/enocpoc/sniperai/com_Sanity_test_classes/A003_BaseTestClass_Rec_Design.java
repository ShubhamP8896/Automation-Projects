package enocpoc.sniperai.com_Sanity_test_classes;
...
import enocpoc.sniperai.com_utility_Classes.Enocpoc_Excel_Data_UtilityClass;
import enocpoc.sniperai.com_utility_Classes.Enocpoc_Take_Screenshot_UtilityClass;
import enocpoc_RecMod_POM_classes.Rec_JobListPage_POM_Class;
import enocpoc_Sanity_POM_Classes.LoginPage;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://enocpoc.sniperai.com/login");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(27);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
            ...
            Enocpoc_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        } catch (WebDriverException e) {
            System.out.println("WebDriverException occurred: " + e.getMessage());
            Enocpoc_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An exception occurred: " + e.getMessage());
            Enocpoc_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
    }
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Enocpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Enocpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
