...
import globallogic.sniperai.com_utility_Classes.Gloaballogic_Excel_Data_UtilityClass;
import globallogic.sniperai.com_utility_Classes.Gloaballogic_Take_Screenshot_UtilityClass;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://globallogic.sniperai.com/");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(17);
...
//        LP.UserTypeR();
//        System.out.println("Recruiter user type selected");      not required for this
        LP.RememberMe();
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
            ...
            Gloaballogic_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        } catch (WebDriverException e) {
            System.out.println("WebDriverException occurred: " + e.getMessage());
            Gloaballogic_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An exception occurred: " + e.getMessage());
            Gloaballogic_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
    }
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Gloaballogic_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Gloaballogic_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
