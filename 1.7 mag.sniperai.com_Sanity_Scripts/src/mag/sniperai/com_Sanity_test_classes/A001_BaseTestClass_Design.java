...
import mag.sniperai.com_utility_Classes.MAG_Take_Screenshot_UtilityClass;
...
public class A001_BaseTestClass_Design 
{
    ...
    public void SetUp() throws IOException
    {
        ...
        driver.get("https://malaysiaairlines.sniperai.com/login");
    ...
    protected void handleAlert() throws IOException
    {
        try 
        {
            ...
            MAG_Excel_Data_UtilityClass.writeResult("Alert message: " + alertMessage);
