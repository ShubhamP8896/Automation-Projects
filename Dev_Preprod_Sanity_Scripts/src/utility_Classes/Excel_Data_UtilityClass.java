...
public class Excel_Data_UtilityClass {

    // Path of the Excel file
    private static final String EXCEL_FILE_PATH = "C:\\Users\\Shubz008\\Desktop\\Dev_Preprod_Sanity_Automation\\1. Dev_Preprod Sanity Automation Data.xlsx";

    // Method to read recruiter credentials from Excel
    public String[] readRecruiterCredentials() throws IOException {
        try (FileInputStream file = new FileInputStream(EXCEL_FILE_PATH);
             XSSFWorkbook workbook = new XSSFWorkbook(file)) {
            XSSFSheet sheet = workbook.getSheet("Test Data");
            XSSFRow row = sheet.getRow(1);                     // Row index 1 for recruiter
    ...
    public String[] readCandidateCredentials() throws IOException {
        try (FileInputStream file = new FileInputStream(EXCEL_FILE_PATH);
             XSSFWorkbook workbook = new XSSFWorkbook(file)) {
            XSSFSheet sheet = workbook.getSheet("Test Data");
            XSSFRow row = sheet.getRow(2);                        // Row index 2 for candidate
    ...
    public static void writeResult(String actualResult) throws IOException 
    {
             ...
             XSSFWorkbook workbook = new XSSFWorkbook(file))
        {
            ...
            XSSFSheet sheet = workbook.getSheet("DesignServer");
