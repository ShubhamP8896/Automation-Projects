package edgegroup_preprod.sniperai.com_utility_Classes;
...
public class EdgeGroupPreprod_Excel_Data_UtilityClass {

    // Path of the Excel file
    private static final String EXCEL_FILE_PATH = "C:\\Users\\Shubz008\\Desktop\\Dev_Preprod_Sanity_Automation Data\\1. Dev_Preprod Sanity Automation Report.xlsx";
    ...
    public String[] readRecruiterCredentials(int rowIndex) throws IOException {
        try (FileInputStream file = new FileInputStream(EXCEL_FILE_PATH);
            ...
            XSSFRow row = sheet.getRow(rowIndex);                     // Row index 19 for recruiter
    ...
    public String[] readCandidateCredentials(int rowIndex) throws IOException {
        try (FileInputStream file = new FileInputStream(EXCEL_FILE_PATH);
             XSSFWorkbook workbook = new XSSFWorkbook(file)) {
            XSSFSheet sheet = workbook.getSheet("Test Data");
            XSSFRow row = sheet.getRow(rowIndex);                        // Row index 14 for candidate
    ...
    public static void writeResult(String actualResult) throws IOException 
    {
             ...
             XSSFWorkbook workbook = new XSSFWorkbook(file))
        {
            ...
            XSSFSheet sheet = workbook.getSheet("Edge Group Preprod");
