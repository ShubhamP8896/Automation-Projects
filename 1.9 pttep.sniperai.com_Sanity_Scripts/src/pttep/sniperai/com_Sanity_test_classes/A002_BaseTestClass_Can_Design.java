...
import pttep.sniperai.com_utility_Classes.MAG_Take_Screenshot_UtilityClass;
import pttep_CanMod_POM_classes.Can_DashboardPage;
import pttep_Sanity_POM_Classes.LoginPage;
...
public class A002_BaseTestClass_Can_Design 
{
    ...
    private void navigateToUrl() {
        driver.get("https://pttep.sniperai.com/login");
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                MAG_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                MAG_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
