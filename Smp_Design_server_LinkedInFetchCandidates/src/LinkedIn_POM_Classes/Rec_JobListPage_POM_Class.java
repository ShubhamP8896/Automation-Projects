...
//	Add Input In the Job ReqID ColumnFilter
	@FindBy(xpath = "//input [@placeholder='Job Req Id']")
	private WebElement JobReqIDSearchField;

//	Click on the "Pho Developer" Job title
	@FindBy(xpath = "//td[@title='Php Developer']")
	private WebElement EditJob_LinkedIn1;

//	Click on the Job Board
	@FindBy(xpath = "//a[@id='job_board_link']")
	private WebElement JobBoard;

//	Click on the Update Button  
	@FindBy(xpath = "//input [@id='editjobbtn']")
...
//	Constructor for performing actions
	public Rec_JobListPage_POM_Class() {
		PageFactory.initElements(getDriver(), this);

		this.MouseAction = new Actions(getDriver());
	}
...
//	ii)Interview scheduler Report
	public void InterviewSchedulerReport() {
		InterviewSchedulerReport.click();
	}
...
//	Add Input In the Job ReqID ColumnFilter
	public void JobReqSearchField() {
		JobReqIDSearchField.sendKeys("LinkedIn-1");
	}

//	Click on the Edit Job Icon	
	public void EditJobLinkedIn1() {
		EditJob_LinkedIn1.click();
	}
