package aacpoc.sniperai.com_Sanity_test_classes;
...
import aacpoc.sniperai.com_utility_Classes.Aacpoc_Excel_Data_UtilityClass;
import aacpoc.sniperai.com_utility_Classes.Aacpoc_Take_Screenshot_UtilityClass;
import aacpoc_RecMod_POM_classes.Rec_JobListPage_POM_Class;
import aacpoc_Sanity_POM_Classes.LoginPage;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://aacpoc.sniperai.com/login");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(23);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
            ...
            Aacpoc_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        } catch (WebDriverException e) {
            System.out.println("WebDriverException occurred: " + e.getMessage());
            Aacpoc_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An exception occurred: " + e.getMessage());
            Aacpoc_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
    }
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Aacpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Aacpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
