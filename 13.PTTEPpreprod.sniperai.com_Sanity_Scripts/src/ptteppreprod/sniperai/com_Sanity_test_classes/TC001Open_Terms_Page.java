...
public class TC001Open_Terms_Page extends A001_BaseTestClass_Design
{
    ...
    public void TermsPage() throws IOException 
    {
        ...
        try 
        {
            ...
            String ExpectedURLTerms = "https://ptteppreprod.sniperai.com/terms?type=";
        ...
        catch (NoAlertPresentException e) 
        {
            ...
            PTTEPpreprod_Excel_Data_UtilityClass.writeResult("No alert present on the page.");
        ...
        catch (NoSuchElementException e) 
        {
            ...
            PTTEPpreprod_Excel_Data_UtilityClass.writeResult("No web element found on the page.");
        ...
        catch (WebDriverException e) 
        {
            ...
            PTTEPpreprod_Excel_Data_UtilityClass.writeResult("WebDriverException occurred: " + e.getMessage());
        ...
        catch (Exception e) 
        {
            ...
            PTTEPpreprod_Excel_Data_UtilityClass.writeResult("An exception occurred: " + e.getMessage());
        }
