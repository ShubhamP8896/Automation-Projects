...
public class TC001Open_Terms_Page extends A001_BaseTestClass_Design
{
    ...
    public void TermsPage() throws IOException 
    {
        ...
        try 
        {
            ...
            String ExpectedURLTerms = "https://bajajautopreprod.sniperai.com/terms?type=";
        ...
        catch (NoAlertPresentException e) 
        {
            ...
            BajajAutoPreprod_Excel_Data_UtilityClass.writeResult("No alert present on the page.");
