...
import hcltechpoc.sniperai.com_utility_Classes.Hcltechpoc_Take_Screenshot_UtilityClass;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://hcltechpoc.sniperai.com/");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(49);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Hcltechpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Hcltechpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
