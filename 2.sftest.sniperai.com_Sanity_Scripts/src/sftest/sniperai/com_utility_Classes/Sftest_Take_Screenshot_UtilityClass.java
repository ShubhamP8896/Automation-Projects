...
public class Sftest_Take_Screenshot_UtilityClass 
{
	    public static void takeScreenshot(WebDriver driver, String screenshotName) 
	    {
	        ...
	        String destinationFilePath = "D:\\Automation Sanity Testing Data\\Dev and Preprod server Data\\Sanity_Testing_Screenshots_Dev\\2.sftest.sniperai.com_Sanity_SS\\" + screenshotName + ".png";
