package sftest.sniperai.com_utility_Classes;
...
public class Sftest_Excel_Data_UtilityClass {

    // Path of the Excel file
    private static final String EXCEL_FILE_PATH = "D:\\Automation Sanity Testing Data\\Dev and Preprod server Data\\Sanity_Testing_Report_Dev\\1. Dev_Preprod Sanity Automation Report.xlsx";
    ...
    public static void writeResult(String actualResult) throws IOException 
    {
             ...
             XSSFWorkbook workbook = new XSSFWorkbook(file))
        {
            ...
            XSSFSheet sheet = workbook.getSheet("SftestServer");
