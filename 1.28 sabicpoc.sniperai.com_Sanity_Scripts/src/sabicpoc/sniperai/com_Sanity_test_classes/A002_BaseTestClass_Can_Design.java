...
import sabicpoc.sniperai.com_utility_Classes.Sabicpoc_Take_Screenshot_UtilityClass;
import sabicpoc_CanMod_POM_classes.Can_DashboardPage;
...
public class A002_BaseTestClass_Can_Design 
{
    ...
    private void navigateToUrl() {
        driver.get("https://sabicpoc.sniperai.com/");
    ...
    private void performLogin() throws IOException {
        ...
        LP.fetchCandidateCredentials(58);
        LP.CMSendUsername();
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Sabicpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Sabicpoc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
