...
import poc.sniperai.com_utility_Classes.Poc_Take_Screenshot_UtilityClass;
...
public class A003_BaseTestClass_Rec_Design 
{
    ...
    {
        driver.get("https://poc.sniperai.com/");
    ...
    private void performLogin() throws IOException 
    {
        ...
        LP.fetchRecruiterCredentials(37);
...
//          Excel_Data_UtilityClass.writeResult("Test case failed - Incorrect credentials. Alert message: " + alertMessage);
    ...
    public void teardown(ITestResult result) 
    {
        try 
        {
            ...
            {
                Poc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName() + "_Failure_Screenshot");
                System.out.println("Failure Screenshot taken Successfully");
            } 
            else 
            {
                Poc_Take_Screenshot_UtilityClass.takeScreenshot(driver, result.getName());
